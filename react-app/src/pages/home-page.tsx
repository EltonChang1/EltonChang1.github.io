...
import { FileDown, GitPullRequest, Mail } from "lucide-react";
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <p className="mx-auto mb-8 max-w-3xl text-center text-lg leading-relaxed text-muted-foreground">
            Public, reviewable contributions spanning AI inference, data
            engines, machine-learning tooling, scientific Python, and
            visualization.
          </p>
